...
import serviceBackgroundImage from './assets/background3.jpg'; 
import beforeandafterImage from './assets/beforeandafter.jpeg'; // Import the before and after image
...
<Box sx={{ display: 'flex', justifyContent: 'center', gap: 2, mt: 4 }}>
          <Box>
            <Typography variant="h6" sx={{ textAlign: 'center', mb: 2, color: '#483248', fontWeight: 'bold' }}>Before and After</Typography>
            <img src={beforeandafterImage} alt="beforeandafter" style={{ width: '100%', borderRadius: '8px' }} />
          </Box>
        </Box>
